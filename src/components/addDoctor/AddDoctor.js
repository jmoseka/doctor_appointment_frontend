        ...
        <form className="doc-form">
          ...
          <div className="form-group">
            ...
            <label htmlFor="reserve-no" className="ms-4 mb-1">
              <input type="radio" name="reserve-yes" className="form-control rounded-pill input-radio" checked required />
              Yes
            </label>
            <label htmlFor="reserve-yes" className="ms-4 mb-1">
              <input type="radio" name="reserve-no" className="form-control rounded-pill input-radio" required />
              No
            </label>
          </div>
