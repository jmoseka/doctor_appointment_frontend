        ...
        <div className="container-signup d-md-flex">
            <section className='section-logo text-center'>
                ...
                <div className='logo-text hidden mt-5'>
                    <p className='p-2'>The leading online booking website 
                        for doctors anywhere, anytime. Take care of your body it will take care of you</p>
                </div>
