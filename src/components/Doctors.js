    ...
    <div>
      ...
      <div className="doctors-list">
        <div className="doctors1">
          <img src={doctor1} alt="image of doctor" className="doctors-images" />
          <h4>
            {
        ...
        <div className="doctors2">
          <img src={doctor2} alt="image of doctor" className="doctors-images" />
          <h4>{
            //this is a link to the doctor's details page}
        ...
        <div className="doctors2">
          <img src={doctor3} alt="image of doctor" className="doctors-images" />
          <h4>
            {
              //this is a link to the doctor's details page}
